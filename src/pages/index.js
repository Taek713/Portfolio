    ...
    <div className="section__inner">
      <div className="block">
        ...
        <ul className="anchornav">
          ...
          <li><a href="/shitposts">Sh*tPosts <span>#6 Click here to see my Shit posting page</span></a></li>
        </ul>
      </div>
    </div>
  ...
  <section className="section section--clients" id="clients">
    ...
    <div className="section__inner">
      <div className="block">
        ...
        <p className="lead">Here are just some of my clients, I've had the pleasure working with:</p>
       <ol className="list">
  <li className="list--item">
    <a href="javascript:void(0)" className="list--link">
       <a className="list--link__header" href="https://mainstreetpontiac.org/"><span>Main Street Pontiac</span></a> 
      {/* <p className="list--link__description">The counter-reset CSS property resets a CSS counter to a given value.</p> */}
    </a>
  </li>
  <li className="list--item">
    <a href="javascript:void(0)" className="list--link">
    <a className="list--link__header" href="https://lafayettegrande.com/"><span>Lafayette Grande</span></a> 
      {/* <p className="list--link__description">The counter-increment CSS property increases or decreases the value of a CSS counter by a given value.</p> */}
    </a>
  </li>
  <li className="list--item">
    <a href="javascript:void(0)" className="list--link">
    <a className="list--link__header" href="https://www.cityoffortmeade.com/"><span>Fort Meade, Florida</span></a> 
      {/* <p className="list--link__description">The content CSS property replaces an element with a generated value. Objects inserted using the content property are anonymous replaced elements.</p> */}
    </a>
  </li>
  <li className="list--item">
    <a href="javascript:void(0)" className="list--link">
    <a className="list--link__header" href="https://www.cityoffortmeade.com/"><span>Independence, Ohio</span></a> 
      {/* <p className="list--link__description">The pseudo-elements generated by ::before and ::after are contained by the element's formatting box, and thus don't apply to replaced elements such as img, or to elements.</p> */}
    </a>
  </li>
  <li className="list--item">
    <a href="javascript:void(0)" className="list--link">
    <a className="list--link__header" href="https://universalhca.com/"><span>Universal Heathcare Associates</span></a> 
      {/* <p className="list--link__description">Absolute positioning brings very different results.</p> */}
    </a>
  </li>
  <li className="list--item">
    <a href="javascript:void(0)" className="list--link">
    <a className="list--link__header" href="https://embassyhealthcare.net/"><span>Embassy Healthcare</span></a> 
      {/* <p className="list--link__description">Media queries are useful when you want to modify your site or app depending on a device's general type (such as print vs. screen) or specific characteristics and parameters (such as screen resolution or browser viewport width).</p> */}
    </a>
  </li>
</ol>
</div>
